...
resource "aws_wafv2_web_acl" "main" {
  ...
  # AWS Managed — Core Rule Set (covers common exploits incl. SQLi, XSS)
  rule {
  ...
  # AWS Managed — Known Bad Inputs (XSS and other injection attacks)
  rule {
  ...
  rule {
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "${var.project_name}-${var.environment}-linux-rules"
      sampled_requests_enabled   = true
    }
  }
