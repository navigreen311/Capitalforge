...
const NAV_PILLARS: NavPillar[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Tax',              href: '/financial-control/tax',         icon: 'TX' },
      { label: 'Simulator',        href: '/financial-control/simulator',   icon: 'SI' },
      { label: 'Hardship',         href: '/financial-control/hardship',    icon: 'HS' },
    ],
  },
  {
    title: 'Compliance',
    ...
    items: [
      ...
      { label: 'Documents',        href: '/compliance/documents',          icon: 'DO' },
      { label: 'Disclosures',      href: '/compliance/disclosures',        icon: 'DI' },
      { label: 'Contracts',        href: '/compliance/contracts',          icon: 'CT' },
      { label: 'Complaints',       href: '/compliance/complaints',         icon: 'CM' },
      { label: 'Regulatory',       href: '/compliance/regulatory',         icon: 'RG' },
      { label: 'Comm Compliance',  href: '/compliance/comm-compliance',    icon: 'CC' },
      { label: 'Training',         href: '/compliance/training',           icon: 'TR' },
      { label: 'Decisions',        href: '/compliance/decisions',          icon: 'DS' },
    ],
  },
  {
    title: 'Platform',
    defaultOpen: false,
    items: [
      { label: 'CRM',              href: '/platform/crm',              icon: 'CR' },
      { label: 'Admin',            href: '/multi-tenant',               icon: 'AD' },
      { label: 'Issuers',          href: '/platform/issuers',           icon: 'IS' },
      { label: 'Referrals',        href: '/platform/referrals',         icon: 'RF' },
      { label: 'Workflows',        href: '/platform/workflows',         icon: 'WF' },
      { label: 'Settings',         href: '/settings',                   icon: 'SE' },
      { label: 'Reports',          href: '/platform/reports',           icon: 'RE' },
      { label: 'Portfolio',        href: '/portfolio',                  icon: 'PF' },
      { label: 'Offboarding',      href: '/platform/offboarding',       icon: 'OB' },
      { label: 'Data Lineage',     href: '/platform/data-lineage',      icon: 'DL' },
    ],
  },
];
