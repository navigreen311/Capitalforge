...
export async function createBusiness(
  ...
  const business = await prisma.business.create({
    data: {
      ...
      // Collected by the onboarding wizard and, until these columns existed,
      // dropped between the form and the record.
...
export async function addOwner(
  ...
  const owner = await prisma.businessOwner.create({
    data: {
      ...
      personalGuarantee: input.personalGuarantee ?? false,
